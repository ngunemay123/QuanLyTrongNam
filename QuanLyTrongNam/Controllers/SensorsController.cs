...
namespace QuanLyTrongNam.Controllers
{
    public class SensorsController : Controller
    {
        ...
        public SensorsController(QuanLyTrongNamContext context)
        {
            _context = context;
        }
        ...
        {
            var quanLyTrongNamContext = _context.Sensors.Include(s => s.Farm);
        ...
        public async Task<IActionResult> Create([Bind("SensorId,SensorName,SensorType,FarmId")] Sensor sensor)
        {
            ...
            ViewData["FarmId"] = new SelectList(_context.Farms, "FarmId", "FarmId", sensor.FarmId);
            return View(sensor);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["FarmId"] = new SelectList(_context.Farms, "FarmId", "FarmName", sensor.FarmId);
            return View(sensor);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SensorId,SensorName,SensorType,FarmId")] Sensor sensor)
        {
