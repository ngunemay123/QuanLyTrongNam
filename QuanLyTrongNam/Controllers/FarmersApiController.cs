...
namespace QuanLyTrongNam.Controllers
{
    ...
    [ApiController]
    public class FarmersApiController : ControllerBase
    {
        private readonly QuanLyTrongNamContext _context;

        public FarmersApiController(QuanLyTrongNamContext context)
        {
            _context = context;
        }
